        ...
        <AlertDialogHeader>
          ...
          <AlertDialogDescription asChild>
            <div className="text-sm text-muted-foreground space-y-3">
              <p>
                {t('taskReview:discard.confirmMessage')} <strong className="text-foreground">"{task.title}"</strong>?
              </p>
              <p className="text-destructive">
                {t('taskReview:discard.destructiveWarning')}
              </p>
          ...
          >
            {isDiscarding ? (
              ...
              <>
                ...
                {t('taskReview:discard.discardBuild')}
              </>
            )}
          </AlertDialogAction>
        </AlertDialogFooter>
