      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          <Badge variant="outline" className="text-xs">
            {openIssuesCount} {t('github:header.open')}
          </Badge>
          <Button
            variant="ghost"
            size="icon"
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  ...
                  {t('github:header.analyzeGroup')}
                </Button>
              </TooltipTrigger>
              <TooltipContent side="bottom" className="max-w-xs">
                <p>{t('github:header.analyzeGroupTooltip')}</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        )}
          ...
          <div className="flex items-center gap-2 p-2 rounded-lg bg-muted/50 border border-border">
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent side="bottom" className="max-w-xs">
                  <p>{t('github:header.autoFixTooltip')}</p>
                  {autoFixRunning && autoFixProcessing !== undefined && autoFixProcessing > 0 && (
                    <p className="mt-1 text-primary">{t('github:header.autoFixProcessing', { count: autoFixProcessing })}</p>
                  )}
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
