        ...
        <DialogContent>
          ...
          <div className="py-4 space-y-4 max-h-96 overflow-y-auto">
            <div className="space-y-3">
              <h4 className="text-sm font-medium">{t('config.ideationTypes')}</h4>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm">{t('config.includeRoadmapContext')}</span>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm">{t('config.includeKanbanContext')}</span>
                <Switch
        ...
        <DialogContent>
          ...
          <div className="py-4 space-y-3 max-h-96 overflow-y-auto">
            {availableTypesToAdd.length === 0 ? (
              <div className="text-center py-6 text-muted-foreground">
                ...
                <p>{t('addMore.allTypesGenerated')}</p>
                <p className="text-sm mt-1">{t('addMore.regenerateSuggestion')}</p>
              </div>
            ) : (
          ...
          <DialogFooter className="flex items-center justify-between">
            <div className="text-sm text-muted-foreground">
              {typesToAdd.length > 0 && t('addMore.selected', { count: typesToAdd.length })}
            </div>
            <div className="flex gap-2">
              ...
              >
                ...
                {typesToAdd.length > 0 ? t('addMore.generate', { count: typesToAdd.length }) : t('addMore.generateIdeas')}
              </Button>
            </div>
          </DialogFooter>
        </DialogContent>
