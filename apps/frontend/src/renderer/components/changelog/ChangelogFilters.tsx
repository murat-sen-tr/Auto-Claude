    ...
    <div className="w-80 shrink-0 border-r border-border overflow-y-auto">
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-3">
          <Label className="text-sm font-medium">{t('filters.sourceLabel')}</Label>
          <RadioGroup
            value={sourceMode}
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
                  ...
                  <SelectContent>
                    <SelectItem value="since-version">
                      <div className="flex items-center gap-2">
                        ...
                        {t('filters.sinceVersion')}
                      </div>
                    </SelectItem>
                    <SelectItem value="recent">
                      <div className="flex items-center gap-2">
                        <History className="h-3 w-3" />
                        {t('filters.recentCommits')}
                      </div>
                    </SelectItem>
              ...
              {gitHistoryType === 'since-date' && (
                <div className="space-y-2">
                  <Label className="text-xs">{t('filters.dateLabel')}</Label>
                  <Input
                    type="date"
              ...
              {gitHistoryType === 'since-version' && (
                <div className="space-y-2">
                  <Label className="text-xs">{t('filters.versionLabel')}</Label>
              ...
              >
                {isLoadingCommits ? (
                  <>
                    ...
                    {t('filters.loadingCommits')}
                  </>
                ) : isLoadingGitData ? (
                  <>
                    <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                    {t('filters.loadingGitData')}
                  </>
                ) : (
                  <>
